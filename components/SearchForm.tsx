...
export const formSchema = z.object({
  location: z.string().min(2, "please insert at least two letters ").max(50),
  dates: z.object({
    from: z.date(),
    to: z.date(),
  }),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormMessage />
                <FormControl>
                  <Input placeholder="Bucharest, Romania" {...field} />
                </FormControl>
              </FormItem>
            )}
          />
                  ...
                  <PopoverTrigger asChild>
                    <FormControl>
                      <Button
                        ...
                        variant={"outline"}
                        className={cn(
                          "w-full ;g:w-[300] justify-start text-left font-normal",
